:: run in conda environment with python=3.8 and pypi package trdg installed
...
trdg -c 10000 -w 1 -f 96 -b 1 -fd "handwritten_fonts" -na 2 --output_dir handwritten_words/white_word &
trdg -c 10000 -w 1 -f 96 -b 1 -bl 2 -fd "handwritten_fonts" -na 2 --output_dir handwritten_words/white_blur_word &
trdg -c 10000 -w 1 -f 96 -b 1 -d 3 -fd "handwritten_fonts" -na 2 --output_dir handwritten_words/white_distort_word &
trdg -c 10000 -w 1 -f 96 -b 0 -fd "handwritten_fonts" -na 2 --output_dir handwritten_words/noise_word &
trdg -c 10000 -w 1 -f 96 -b 0 -bl 2 -fd "handwritten_fonts" -na 2 --output_dir handwritten_words/noise_blur_word &
trdg -c 10000 -w 1 -f 96 -b 0 -d 3 -fd "handwritten_fonts" -na 2 --output_dir handwritten_words/noise_distort_word &
trdg -c 10000 -w 1 -f 96 -b 3 -id sepia -fd "handwritten_fonts" -na 2 --output_dir handwritten_words/sepia_word &
trdg -c 10000 -w 1 -f 96 -b 3 -bl 2 -id sepia -fd "handwritten_fonts" -na 2 --output_dir handwritten_words/sepia_blur_word &
trdg -c 10000 -w 1 -f 96 -b 3 -d 3 -id sepia -fd "handwritten_fonts" -na 2 --output_dir handwritten_words/sepia_distort_word 
